...
if [ -f "$ROOT/system/control-plane/state/migrations/0004_system_twin.sql" ]; then
...
if grep -q 'system_twin_edge' "$ROOT/system/control-plane/state/migrations/0004_system_twin.sql" 2>/dev/null; then
...
if grep -q 'system_twin_node' "$ROOT/system/control-plane/state/migrations/0004_system_twin.sql" 2>/dev/null; then
