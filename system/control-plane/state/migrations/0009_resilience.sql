-- ============================================================================
-- MIGRATION 0009 — RESILIENCE PLANE (HA/DR/Backup domain model)
-- ============================================================================
...
CREATE TABLE resilience_requirements (
...
-- Indeksy
CREATE INDEX idx_backup_catalog_snapshot ON backup_catalog(snapshot_id);
CREATE INDEX idx_resilience_req_tier ON resilience_requirements(tier);
CREATE INDEX idx_game_days_tier ON game_days(tier);
CREATE INDEX idx_spof_status ON spof_findings(status);
