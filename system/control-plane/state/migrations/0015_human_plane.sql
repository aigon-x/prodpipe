-- ============================================================================
-- MIGRATION 0015 — HUMAN PLANE (manual testing + UX governance domain model)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS manual_charters (
...
CREATE TABLE IF NOT EXISTS ux_studies (
...
-- Indeksy
CREATE INDEX IF NOT EXISTS idx_manual_charters_service ON manual_charters(service_id);
CREATE INDEX IF NOT EXISTS idx_manual_charters_tier ON manual_charters(tier);
CREATE INDEX IF NOT EXISTS idx_manual_sessions_charter ON manual_sessions(charter_id);
CREATE INDEX IF NOT EXISTS idx_manual_sessions_tester ON manual_sessions(tester);
CREATE INDEX IF NOT EXISTS idx_uat_signoffs_service ON uat_signoffs(service_id);
CREATE INDEX IF NOT EXISTS idx_ux_studies_service ON ux_studies(service_id);
CREATE INDEX IF NOT EXISTS idx_friction_journey ON friction_baselines(service_id);

-- MAN-06: findings manualne → testy automatyczne (conversion).
-- Idempotentne: dodaje kolumnę tylko gdy nie istnieje.
