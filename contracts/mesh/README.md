...
> Kontrakty mesh — kanoniczna definicja interfejsu mesh.

## 1. Purpose
Przechowuje kanoniczne definicje kontraktów mesh jako stan pożądany.

## 2. Owner
`STATUS: UNDEFINED`

## 3. Source of Truth
Git (desired state). Kanoniczne definicje kontraktów mesh.

## 4. Contains
Definicje kontraktów mesh.
