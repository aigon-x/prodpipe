...
> Kontrakty evidence — kanoniczna definicja dowodów.

## 1. Purpose
Przechowuje kanoniczne definicje kontraktów evidence (dowodów) jako stan pożądany.

## 2. Owner
`STATUS: UNDEFINED`

## 3. Source of Truth
Git (desired state). Kanoniczne definicje kontraktów evidence.

## 4. Contains
Definicje kontraktów evidence.
