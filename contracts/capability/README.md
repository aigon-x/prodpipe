...
> Kontrakty capability — kanoniczna definicja zdolności platformy.

## 1. Purpose
Przechowuje kanoniczne definicje capability (zdolności) jako stan pożądany.

## 2. Owner
`STATUS: UNDEFINED`

## 3. Source of Truth
Git (desired state). Kanoniczne definicje capability.

## 4. Contains
Definicje capability (zdolności).
