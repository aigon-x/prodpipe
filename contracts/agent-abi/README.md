...
> Kontrakt ABI agentów — kanoniczna definicja interfejsu agentów.

## 1. Purpose
Przechowuje kanoniczną definicję ABI agentów jako stan pożądany.

## 2. Owner
`STATUS: UNDEFINED`

## 3. Source of Truth
Git (desired state). Kanoniczna definicja ABI agentów.

## 4. Contains
Definicje ABI agentów.
