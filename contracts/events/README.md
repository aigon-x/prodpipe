...
> Kontrakty zdarzeń — kanoniczna definicja zdarzeń.

## 1. Purpose
Przechowuje kanoniczne definicje kontraktów zdarzeń (events) jako stan pożądany.

## 2. Owner
`STATUS: UNDEFINED`

## 3. Source of Truth
Git (desired state). Kanoniczne definicje kontraktów zdarzeń.

## 4. Contains
Definicje kontraktów zdarzeń.
